...
class LessonOrgFormService extends Service {
    ...
    async getByCondition(condition) {
        let data = await this.ctx.model.LessonOrganizationForm.findOne({
            where: condition,
        });
    ...
    async getAllAndExtraByCondition(condition, include) {
        const ret = await this.ctx.model.LessonOrganizationForm.findAll({
            include,
            where: condition,
        });
    ...
    async updateForm(params, authParams) {
        ...
        const data = await this.ctx.model.LessonOrganizationForm.update(
            params,
            {
                where: { id: params.id },
            }
    ...
    async postForm(params) {
        ...
        const submit = await this.ctx.model.LessonOrganizationFormSubmit.create(
            params
        );
    ...
    async getAllSubmit(params, authParams, queryOptions) {
        ...
        const { id } = params;
        const result = await this.ctx.model.LessonOrganizationFormSubmit.findAndCountAll(
            { ...queryOptions, where: { formId: id } }
        );
    ...
    async updateFormSubmit(params, authParams) {
        ...
        const ok = await this.ctx.model.LessonOrganizationFormSubmit.update(
            { comment, state, quizzes },
            { where: { id: submitId, formId: id } }
        );
        return ok;
    }
}
